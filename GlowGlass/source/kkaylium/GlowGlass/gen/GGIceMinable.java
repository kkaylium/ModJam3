...
public class GGIceMinable extends WorldGenerator {
	...
	public GGIceMinable(int par1, int par2)
	{
		this(par1, par2, Block.ice.blockID);
	}
	
	public GGIceMinable(int par1, int par2, int par3)
	{
	...
	public GGIceMinable(int id, int meta, int number, int target)
	{
