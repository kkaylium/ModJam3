...
public class GGGateSuperType extends BlockFenceGate{

	public static final String[] gateNames = new String[]{"WHITE", "BLACK", "RED", "ORANGE", "YELLOW", "GREEN", "LIGHTBLUE", "BLUE", "PURPLE", "PINK", "RAINBOW"};
	@SideOnly(Side.CLIENT)
	private Icon[] icons;
	private final String field_94464_a;
	
	public GGGateSuperType(int par1, String par2String)
    {
        super(par1);
	...
	{
		this.icons = new Icon[gateNames.length];
		
		for(int i = 0; i < this.icons.length; i++)
		{
			this.icons[i] = iconRegister.registerIcon("glowglass:" + this.field_94464_a + gateNames[i]);
		}
	}
     ...
     */
    public Icon getOldIcon(int par1, int par2)
    {
     ...
     */
    public void registerIconsOld(IconRegister par1IconRegister) {}
}
