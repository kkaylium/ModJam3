...
public class BlockGlowFence extends BlockFence{
	...
	*/
	...
	public boolean canConnectFenceTo(IBlockAccess par1BlockAccess, int par2, int par3, int par4)
	{
		...
		if(l != this.blockID && l != Block.fenceGate.blockID && l != GGBlocks.GlowFenceBLACKDefaultID && l != GGBlocks.GlowFenceWHITEDefaultID && l != GGBlocks.GlowFenceREDDefaultID && l != GGBlocks.GlowFenceORANGEDefaultID && l != GGBlocks.GlowFenceYELLOWDefaultID && l != GGBlocks.GlowFenceGREENDefaultID && l != GGBlocks.GlowFenceLIGHTBLUEDefaultID && l != GGBlocks.GlowFenceBLUEDefaultID && l != GGBlocks.GlowFencePURPLEDefaultID && l != GGBlocks.GlowFencePINKDefaultID && l != GGBlocks.GlowFenceSPECIALDefaultID && l != GGBlocks.GlowGlassDefaultID && l != GGBlocks.GlowFenceBLACKDefaultID && l != GGBlocks.GlowFenceWHITEDefaultID && l != GGBlocks.GlowGateREDDefaultID && l != GGBlocks.GlowGateORANGEDefaultID && l != GGBlocks.GlowGateYELLOWDefaultID && l != GGBlocks.GlowGateGREENDefaultID && l != GGBlocks.GlowGateLIGHTBLUEDefaultID && l != GGBlocks.GlowGateBLUEDefaultID && l != GGBlocks.GlowGatePURPLEDefaultID && l != GGBlocks.GlowGatePINKDefaultID && l != GGBlocks.GlowGateSPECIALDefaultID)
		{
