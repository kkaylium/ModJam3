...
public class BlockGlowGateORANGE extends BlockFenceGate{

	public BlockGlowGateORANGE(int par1) {
		super(par1);
	...
	{
		return GGBlocks.GlowFenceORANGE.getBlockTextureFromSide(par1);
	}
