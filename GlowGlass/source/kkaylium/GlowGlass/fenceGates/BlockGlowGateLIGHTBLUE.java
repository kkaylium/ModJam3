...
public class BlockGlowGateLIGHTBLUE extends BlockFenceGate{
	
	public BlockGlowGateLIGHTBLUE(int par1) {
		super(par1);
	...
	{
		return GGBlocks.GlowFenceLIGHTBLUE.getBlockTextureFromSide(par1);
	}
