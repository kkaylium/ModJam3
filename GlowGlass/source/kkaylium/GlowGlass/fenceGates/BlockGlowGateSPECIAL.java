...
public class BlockGlowGateSPECIAL extends BlockFenceGate{
	
	public BlockGlowGateSPECIAL(int par1) {
		super(par1);
	...
	{
		return GGBlocks.GlowFenceSPECIAL.getBlockTextureFromSide(par1);
	}
