...
public class BlockGlowGateYELLOW extends BlockFenceGate{
	
	public BlockGlowGateYELLOW(int par1) {
		super(par1);
	...
	{
		return GGBlocks.GlowFenceYELLOW.getBlockTextureFromSide(par1);
	}
