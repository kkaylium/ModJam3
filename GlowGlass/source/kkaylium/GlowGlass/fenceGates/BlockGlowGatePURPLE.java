...
public class BlockGlowGatePURPLE extends BlockFenceGate{
	
	public BlockGlowGatePURPLE(int par1) {
		super(par1);
	...
	{
		return GGBlocks.GlowFencePURPLE.getBlockTextureFromSide(par1);
	}
